---
sidebar: sidebar
permalink: reference-limitations-aws-9100.html
...
= Known limitations for Cloud Volumes ONTAP 9.10.0 in AWS
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The following known limitations are specific to Cloud Volumes ONTAP in Amazon Web Services. Be sure to also review link:reference-limitations-9100.html[Limitations for Cloud Volumes ONTAP 9.10.0 in all cloud providers].
